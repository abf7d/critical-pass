...
export class PhaseFactoryService {
  ...
  constructor(private colorFactory: ColorFactoryService, private phaseSerializer: PhaseSerializerService, private phaseSummarySerializer: PhaseSummarySerializerService) { }
